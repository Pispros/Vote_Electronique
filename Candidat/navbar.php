...
<nav class="navbar navbar-expand-lg navbar-dark default-color-dark">
  ...
  <!-- Navbar brand -->
  <a class="navbar-brand" href="./"><img src="../assets/img/candidats/<?php echo $row[0][0]; ?>" style="width: 70px;height: 70px;border-radius: 50px;"></a>
  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
    ...
    <ul class="navbar-nav mr-auto" style="width: 100%;display: flex !important;flex-flow: row nowrap!important;justify-content: space-around!important;">
      <li class="nav-item">
          <a class="nav-link hoverA" href="./professionfoi.php" style="font-weight: bolder;font-size: 22px;"><i class="far fa-comment-alt" style="position: relative;top: 3px;"></i>&nbsp;Profession de Foi</a>
      </li>
      <li class="nav-item">
