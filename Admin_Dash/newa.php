...
<div class="row d-flex justify-content-start">
 	<div class="col-auto">
 			<span style="font-size: 25px;color: #4db6ac;">Administration > <a href="list_users.php?type=admin" style="font-size: 25px;color: #4db6ac;">Liste du Personnel</a> > Nouvel Admin </span>
 	</div>
</div>
<br>
<div class="row d-flex justify-content-center">
 	<div class="col-auto">
 			<button type="button" class="btn btn-outline-info rounded-pill">Formulaire Nouvel Admin &nbsp;<i class="fas fa-user-plus"></i></button>
 	</div>
</div>
<br>
<form method="post" action="./options/admin_options.php?action=new_admin" enctype="multipart/form-data" onsubmit="RecallPath();">
...
<div class="row d-flex justify-content-around" id="personne">
	  ...
	  <div class="col-12 col-md-5">
	  		<div class="row">
	  			  ...
	  			  <div class="col-12">
	  			  		<input required="" type="text" name="lib_elec" id="lib_elec" class="form-control myI">
	  			  </div>
	  		</div>
	  </div>
